...
public class DragLayer extends InsettableFrameLayout {
    ...
    public void setup(Launcher launcher, DragController dragController, AllAppsTransitionController allAppsTransitionController) {
        ...
        boolean isAccessibilityEnabled = ((AccessibilityManager) mLauncher.getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled();
    ...
    public void onAccessibilityStateChanged(boolean isAccessibilityEnabled) {
        mPinchListener = FeatureFlags.LAUNCHER3_DISABLE_PINCH_TO_OVERVIEW || isAccessibilityEnabled ? null : new PinchToOverviewListener(mLauncher);
    }
        ...
        if (topView != null && intercept) {
            ...
            if (textView != null) {
                ...
                if (isInAccessibleDrag()) {
                    ...
                    mLauncher.getUserEventDispatcher().logActionTapOutside(LoggerUtils.newContainerTarget(topView.getLogContainerType()));
                    topView.close(true);
    ...
    private void sendTapOutsideFolderAccessibilityEvent(boolean isEditingName) {
        ...
        Utilities.sendCustomAccessibilityEvent(this, AccessibilityEvent.TYPE_VIEW_FOCUSED, getContext().getString(stringId));
    }
    ...
    public void addResizeFrame(LauncherAppWidgetHostView widget, CellLayout cellLayout) {
        ...
        mCurrentResizeFrame = (AppWidgetResizeFrame) LayoutInflater.from(mLauncher).inflate(R.layout.app_widget_resize_frame, this, false);
