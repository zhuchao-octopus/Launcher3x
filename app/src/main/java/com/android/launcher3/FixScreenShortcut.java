...
public class FixScreenShortcut {
    ...
    public static boolean getFixScreenShortcutData(ComponentName cn, ShortcutInfo si) {
    ...
    public static CharSequence getAppAlternativeTitle(Context context, ComponentName cn, CharSequence title) {
        if (context == null || cn == null || title == null) return title;
        ...
        } else if ("net.easyconn.WelcomeActivity".equals(className)) {
            //for 1680 custom
            String locale = Locale.getDefault().getLanguage();
            if (locale != null) {
                if (locale.equals("tr")) {
