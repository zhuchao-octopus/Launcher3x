...
public class DeepShortcutTextView extends BubbleTextView {
    ...
    public DeepShortcutTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDragHandleWidth = resources.getDimensionPixelSize(R.dimen.popup_padding_end) + resources.getDimensionPixelSize(R.dimen.deep_shortcut_drag_handle_size) + resources.getDimensionPixelSize(R.dimen.deep_shortcut_drawable_padding) / 2;
    }
