...
public abstract class LauncherAppsCompat {
    ...
    public static ShortcutInfo createShortcutInfoFromPinItemRequest(Context context, final PinItemRequestCompat request, final long acceptDelay) {
        if (request != null && request.getRequestType() == PinItemRequestCompat.REQUEST_TYPE_SHORTCUT && request.isValid()) {
            ...
            info.iconBitmap = LauncherIcons.createShortcutIcon(compat, context, false /* badged */);
