 ...
 */
public class Folder extends AbstractFloatingView implements DragSource, View.OnClickListener, View.OnLongClickListener, DropTarget, FolderListener, TextView.OnEditorActionListener, View.OnFocusChangeListener, DragListener, DropTargetSource, ExtendedEditText.OnBackKeyListener {
    ...
    @ViewDebug.ExportedProperty(category = "launcher", mapping = {
            @ViewDebug.IntToString(from = STATE_NONE, to = "STATE_NONE"), @ViewDebug.IntToString(from = STATE_SMALL, to = "STATE_SMALL"),
            @ViewDebug.IntToString(from = STATE_ANIMATING, to = "STATE_ANIMATING"), @ViewDebug.IntToString(from = STATE_OPEN, to = "STATE_OPEN"),
    })
    @Thunk
    ...
    public boolean startDrag(View v, DragOptions options) {
        ...
        if (tag instanceof ShortcutInfo) {
            ...
            if (options.isAccessibleDrag) {
                mDragController.addDragListener(new AccessibleDragListenerAdapter(mContent, CellLayout.FOLDER_ACCESSIBILITY_DRAG) {
    ...
    public boolean onBackKey() {
        ...
        Utilities.sendCustomAccessibilityEvent(this, AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED, getContext().getString(R.string.folder_renamed, newTitle));
    ...
    static Folder fromXml(Launcher launcher) {
        return (Folder) launcher.getLayoutInflater().inflate(FeatureFlags.LAUNCHER3_DISABLE_ICON_NORMALIZATION ? R.layout.user_folder : R.layout.user_folder_icon_normalized, null);
    }
    ...
    public void animateOpen() {
        ...
        Animator reveal = new CircleRevealOutlineProvider((int) getPivotX(), (int) getPivotY(), 0, radius).createRevealAnimator(this);
        ...
        anim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                Utilities.sendCustomAccessibilityEvent(Folder.this, AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED, mContent.getAccessibilityDescription());
    ...
    private void animateClosed() {
        ...
        oa.addListener(new AnimatorListenerAdapter() {
            ...
            @Override
            public void onAnimationStart(Animator animation) {
                Utilities.sendCustomAccessibilityEvent(Folder.this, AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED, getContext().getString(R.string.folder_closed));
                mState = STATE_ANIMATING;
            }
        });
    ...
    public boolean acceptDrop(DragObject d) {
        ...
        return ((itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION || itemType == LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT || itemType == LauncherSettings.Favorites.ITEM_TYPE_DEEP_SHORTCUT) && !isFull());
    }
    ...
    public void onDropCompleted(final View target, final DragObject d, final boolean isFlingToDelete, final boolean success) {
        ...
        if (!isFlingToDelete) {
            ...
            mLauncher.exitSpringLoadedDragModeDelayed(successfulDrop, Launcher.EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT, null);
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mContent.getChildCount() > 0) {
            ...
            mFooter.setPadding(mContent.getPaddingLeft() + cellIconGap, mFooter.getPaddingTop(), mContent.getPaddingRight() + cellIconGap, mFooter.getPaddingBottom());
        }
    ...
    public void fillInLogContainerData(LauncherLogProto.LauncherEvent.Builder eventBuilder, Target.Builder srcTargetBuilder, Target.Builder srcParentBuilder, View v, ItemInfo info) {
        ...
        srcTargetBuilder.setPageIndex(mContent.getCurrentPage());
    ...
    public int getLogContainerType() {
        return ContainerType.FOLDER.getNumber();
    }
}
